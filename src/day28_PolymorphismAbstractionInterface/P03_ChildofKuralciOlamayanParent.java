...
public class P03_ChildofKuralciOlamayanParent extends P02_KuralciOlmayanParent{
    ...
    public static void main(String[] args) {
        ...
        P03_ChildofKuralciOlamayanParent obj=new P03_ChildofKuralciOlamayanParent();
        obj.method1();
    }
}
